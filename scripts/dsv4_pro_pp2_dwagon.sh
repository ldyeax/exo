...
export SGLANG_PP_LAYER_PARTITION=44,17
...
export TRITON_CACHE_DIR=/var/lib/exo/cache/dsv4-native-mxfp4/triton-pro-pp2
export FLASHINFER_WORKSPACE_BASE=/var/lib/exo/cache/dsv4-native-mxfp4/flashinfer-pro-pp2
export TORCHINDUCTOR_CACHE_DIR=/var/lib/exo/cache/dsv4-native-mxfp4/torch-pro-pp2
...
exec /usr/bin/numactl --interleave=all \
  ...
  --nnodes 2 \
  --node-rank 0 \
  --dist-init-addr 10.44.0.1:29518 \
