...
export DSV4_LAUNCH_ENTRYPOINT="${repo_root}/scripts/dsv4_flash_fwuff_parity.sh"
...
export DSV4_SWA_FULL_TOKENS_RATIO="${DSV4_SWA_FULL_TOKENS_RATIO:-0.1}"
...
export DSV4_CAPTURE_ATTN_IN_BCG=0
export DSV4_EAGER_ATTN_MODULE_IN_BCG=1
