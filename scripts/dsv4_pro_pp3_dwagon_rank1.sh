...
export TRITON_CACHE_DIR=/var/lib/exo/cache/dsv4-native-mxfp4/triton-pro-pp3-rank1
export FLASHINFER_WORKSPACE_BASE=/var/lib/exo/cache/dsv4-native-mxfp4/flashinfer-pro-pp3-rank1
export TORCHINDUCTOR_CACHE_DIR=/var/lib/exo/cache/dsv4-native-mxfp4/torch-pro-pp3-rank1
...
exec /usr/bin/numactl --cpunodebind=1 --membind=1 \
